...
const CARDS = [
  ...
  { icon: Package, tone: "cyan", title: "Procurement-clean", tag: "Ultralytics Enterprise",
    body: "Built on YOLO11 — benchmarked at ~89–90% mAP@50 vs 84.5% for RT-DETR-L — licensed under the Ultralytics Enterprise License to clear the AGPL-3.0 hurdle for government deployment." },
